		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.HeYuxin.model.Order o=(com.HeYuxin.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.HeYuxin.dao.UserDao userDao=new com.HeYuxin.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.HeYuxin.model.Payment.findByPaymentId(con,n);
						%>
